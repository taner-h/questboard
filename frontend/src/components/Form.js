...
<Divider variant="middle" />
      ...
      <div>
        <FormControl
          sx={{ alignItems: "center", minWidth: 300, marginX: 2, marginY: 2 }}
          component="fieldset"
        >
      ...
      <div>
        <FormControl sx={{ minWidth: 300, width:'65%', maxWidth: 500, marginY: 2, marginX:2 }}>
      ...
      <div>
        <FormControl sx={{ minWidth: 300, marginX: 2, marginY: 2 }}>
          ...
          >
            ...
            <MenuItem value="Tabletop Simulator">Tabletop Simulator</MenuItem>
      ...
      <div>
        ...
        <FormControl sx={{ minWidth: 300, marginX: 2, marginY: 2 }}>
          ...
          >
            ...
            <MenuItem value="Heavy worldbuilding">Heavy worldbuilding</MenuItem>
      ...
      <div>
        <FormControl display="flex" sx={{ minWidth: 300, width:'75%', maxWidth: 500, marginX: 2, marginY: 2 }}>
          <TextField
      ...
      <div>
        <FormControl sx={{ minWidth: 300, width:'75%', maxWidth: 500, marginX: 2, marginY: 2 }}>
          <Autocomplete
            multiple
            id="tags-outlined"
            options={tagList}
